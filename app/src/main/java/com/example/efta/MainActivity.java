...
public class MainActivity extends AppCompatActivity {
    ...
    String fail_lvl = "Try Again";

    String entry_lvl="Complete the level in 60seconds";

    String entry_lvl3="Complete the level in 40seconds";
    String entry_lvl6="Complete the level in 90seconds";
    String entry_lvl8="Complete the level in 55seconds";

    String entry_lvl10="Complete the level in 120seconds";
   ...
   int level;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        View menuView = getLayoutInflater().inflate(R.layout.new_menu_3, null);
       ...
       // ImageView share = menuView.findViewById(id.share);
        ...
        btnlevels.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                ImageView lvl1 = findViewById(id.level1);
                ImageView lvl2 = findViewById(id.level2);
                ImageView lvl3 = findViewById(id.level3);
                ImageView lvl4 = findViewById(id.level4);
                ImageView lvl5 = findViewById(id.level5);
                ImageView lvl6 = findViewById(id.level6);
                ImageView lvl7 = findViewById(id.level7);
                ImageView lvl8 = findViewById(id.level8);
                ImageView lvl9 = findViewById(id.level9);
                ImageView lvl10 = findViewById(id.level10);
                ...
                public void onClick(View v) {
                    ...
                    Toast.makeText(getApplicationContext(), entry_lvl, duration).show();
                }
                ...
                lvl3.setOnClickListener(new View.OnClickListener() {
                    public void onClick(View v) {
                        ...
                        Toast.makeText(getApplicationContext(), entry_lvl3, duration).show();
...
// Find the TextView widgets
                lvl8.setOnClickListener(new View.OnClickListener() {
                    public void onClick(View v) {
                        ...
                        Toast.makeText(getApplicationContext(), entry_lvl8, duration).show();
                    }
                });
                lvl6.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                       ...
                       level=6;
                        ...
                        Toast.makeText(getApplicationContext(), entry_lvl6, duration).show();
                    }
                });
                ...
                lvl5.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        cards = new ImageView[]{
                                ...
                                findViewById(R.id.d35),
                                findViewById(R.id.d36),
                                findViewById(R.id.d37),
                                findViewById(R.id.d38),
                                findViewById(R.id.d39),
                                findViewById(R.id.d40),
                                findViewById(R.id.d41),
                                findViewById(R.id.d42),
                                findViewById(R.id.d43),
                                findViewById(R.id.d44),
                                findViewById(R.id.d45),
                                findViewById(R.id.d46),
                                findViewById(R.id.d47),
                                findViewById(R.id.d48),
                        ...
                        ImageView dcardView35 = findViewById(R.id.d35);
                        ImageView dcardView36 = findViewById(R.id.d36);
                        ImageView dcardView37 = findViewById(R.id.d37);
                        ImageView dcardView38 = findViewById(R.id.d38);
                        ImageView dcardView39 = findViewById(R.id.d39);
                        ImageView dcardView40 = findViewById(R.id.d40);
                        ImageView dcardView41 = findViewById(R.id.d41);
                        ImageView dcardView42 = findViewById(R.id.d42);
                        ImageView dcardView43 = findViewById(R.id.d43);
                        ImageView dcardView44 = findViewById(R.id.d44);
                        ImageView dcardView45 = findViewById(R.id.d45);
                        ImageView dcardView46 = findViewById(R.id.d46);
                        ImageView dcardView47 = findViewById(R.id.d47);
                        ImageView dcardView48 = findViewById(R.id.d48);
                        ...
                        dcardView35.setImageResource(cardImages2[34]);
                        dcardView36.setImageResource(cardImages2[35]);
                        dcardView37.setImageResource(cardImages2[36]);
                        dcardView38.setImageResource(cardImages2[37]);
                        dcardView39.setImageResource(cardImages2[38]);
                        dcardView40.setImageResource(cardImages2[39]);
                        dcardView41.setImageResource(cardImages2[40]);
                        dcardView42.setImageResource(cardImages2[41]);
                        dcardView43.setImageResource(cardImages2[42]);
                        dcardView44.setImageResource(cardImages2[43]);
                        dcardView45.setImageResource(cardImages2[44]);
                        dcardView46.setImageResource(cardImages2[45]);
                        dcardView47.setImageResource(cardImages2[46]);
                        dcardView48.setImageResource(cardImages2[47]);
                        ...
                        new Handler().postDelayed(new Runnable() {
                            ...
                            public void run() {
                                ...
                                dcardView35.setImageResource(cardBackImage);
                                dcardView36.setImageResource(cardBackImage);
                                dcardView37.setImageResource(cardBackImage);
                                dcardView38.setImageResource(cardBackImage);
                                dcardView39.setImageResource(cardBackImage);
                                dcardView40.setImageResource(cardBackImage);
                                dcardView41.setImageResource(cardBackImage);
                                dcardView42.setImageResource(cardBackImage);
                                dcardView43.setImageResource(cardBackImage);
                                dcardView44.setImageResource(cardBackImage);
                                dcardView45.setImageResource(cardBackImage);
                                dcardView46.setImageResource(cardBackImage);
                                dcardView47.setImageResource(cardBackImage);
                                dcardView48.setImageResource(cardBackImage);
                ...
                lvl7.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        Toast.makeText(getApplicationContext(), entry_lvl10, duration).show();
                    }
                });
               ...
               lvl9.setOnClickListener(new View.OnClickListener() {
                ...
                lvl10.setOnClickListener(new View.OnClickListener() {
                    public void onClick(View v) {
                        ...
                        level=10;
                        setContentView(R.layout.lvl_10);
       ...
       // });
        ...
        btnset.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                setContentView(R.layout.menu_arcade_2);
            }
                                          ...
                                          public void onClick(View v) {
                                              ...
                                              imageView.setOnClickListener(new View.OnClickListener() {
                                                  public void onClick(View v) {
                                                      ...
                                                      level=33;
                                                      setContentView(R.layout.new_activity_game3);
                ...
                public void onCardClick (View view){
                    if (!isCardFlipped) {
                        ...
                        if (level==3) {
                            ...
                            long countdownDuration=60000;
                            // chronometer.setBase(SystemClock.elapsedRealtime() + countdownDuration);
                            ...
                            chronometer.setOnChronometerTickListener(chronometer1 -> {
                                ...
                                if (elapsedTime >= countdownDuration) {
                                    ...
                                    for(int cc=0; cc<16; cc++){
                                        ...
                                        cards[cc].setVisibility(View.INVISIBLE);

                                    }
                                    Toast.makeText(getApplicationContext(), fail_lvl, duration).show();
                                }
                            });
    ...
    private void checkForMatchlvl1 () {
        if (cardImages1[firstCardIndex] == cardImages1[secondCardIndex]) {
            // Cards match, perform your match logic here
            // For example, hide both cards
